...
public class AuthorizationActivity extends AppCompatActivity implements AuthorizationPresenter.View{

    private AuthorizationPresenter authPresenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initView();
        authPresenter = new AuthorizationPresenter(this, this);
        ...
        btnAuthorization.setOnClickListener(v -> {
            ...
            authPresenter.setLoginAndPassword(login, password);
            authPresenter.validateForm();

            if (!TextUtils.isEmpty(login) && !TextUtils.isEmpty(password)) {

                authPresenter.checkLoginUser();
